      ...
      privacy: {
        ...
        content: (
          <div>
            {language === 'he' ? (
              <>
                <p>אנו במערכת ez-lines מכבדים את פרטיות המשתמשים ומחויבים להגן על המידע האישי שלהם.</p><br />
                <h4>איסוף מידע</h4>
                ...
                <h4>כתב ויתור</h4>
                <p>השימוש באתר הינו באחריות המשתמש בלבד. {'ez-lines'} לא תישא באחריות לכל נזק ישיר או עקיף, כולל אובדן מידע, הנובע משימוש באתר או ממידע שנמסר באמצעותו.</p><br />
      ...
      terms: {
        ...
        content: (
          <div>
            {language === 'he' ? (
              <>
                <p>השימוש במערכת {'ez-lines'} מהווה הסכמה מלאה מצד המשתמש לתנאים המפורטים להלן:</p><br />
                <h4>שימוש במערכת</h4>
                <p>השירות ניתן כמות שהוא ("As Is"). איננו מתחייבים לזמינות מלאה או לתפקוד ללא תקלות בכל עת.</p><br />
                <p>המשתמש אחראי לוודא כי המידע שהוא מזין נכון ועדכני. {'ez-lines'} אינה אחראית להשלכות של מידע שגוי.</p><br />
                ...
                <h4>ויתור מאחריות</h4>
                <p>{'ez-lines'} לא תישא באחריות לכל נזק, ישיר או עקיף, שייגרם עקב שימוש או חוסר יכולת להשתמש במערכת, לרבות תקלות טכניות או זמינות.</p><br />
      ...
      security: {
        ...
        content: (
          <div>
            {language === 'he' ? (
              <>
                <p>{'ez-lines'} מחויבת לשמור על אבטחת המידע של משתמשיה באמצעות טכנולוגיות אבטחה מתקדמות ופרוטוקולים מקובלים.</p><br />
                <h4>הצפנה ואחסון</h4>
                ...
                <h4>אחריות המשתמש</h4>
                <p>על המשתמש לוודא שהוא שומר על סיסמאותיו ואמצעי ההזדהות שלו בסוד. {'ez-lines'} לא תישא באחריות לנזקים הנובעים משימוש לא מורשה בפרטי ההזדהות של המשתמש.</p><br />
                <h4>ויתור מאחריות</h4>
