...
const translations = {
  en: {
    ...
    'day.5': 'Friday',
    'day.6': 'Saturday',
    'schedule.confirmation.user': 'Hi {{name}}, your appointment at {{businessName}} has been scheduled for {{day}} {{date}} at {{time}}. Cancellation link {{timeUntilLabel}}: {{link}}',
    'schedule.confirmation.user.update': 'Hi {{name}}, your appointment at {{businessName}} has been updated to {{day}} {{date}} at {{time}}. Cancellation link {{timeUntilLabel}}: {{link}}',
    ...
    'manage.message.started': 'The appointment has started',
  ...
  he: {
    ...
    'day.5': 'שישי',
    'day.6': 'שבת',
    'schedule.confirmation.user': 'היי {{name}}, נקבע לך תור ל{{businessName}}, יום {{day}} ה-{{date}} בשעה {{time}}. לינק לניהול התור {{timeUntilLabel}}: {{link}}',
    'schedule.confirmation.user.update': 'היי {{name}}, התור שלך ב-{{businessName}} עודכן ליום {{day}} ה-{{date}} בשעה {{time}}. לינק לניהול התור {{timeUntilLabel}}: {{link}}',
    ...
    'manage.message.started': 'התור כבר התחיל',
